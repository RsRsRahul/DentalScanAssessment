...
.shadow-\[0_-10px_20px_rgba\(0\2c 0\2c 0\2c 0\.2\)\] {
  --tw-shadow: 0 -10px 20px rgba(0,0,0,0.2);
...
.drop-shadow-\[0_0_15px_rgba\(0\2c 0\2c 0\2c 0\.8\)\] {
  --tw-drop-shadow: drop-shadow(0 0 15px rgba(0,0,0,0.8));
  filter: var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow);
}
.drop-shadow-md {
...
.focus-within\:bg-zinc-800\/80:focus-within {
  background-color: rgb(39 39 42 / 0.8);
}
